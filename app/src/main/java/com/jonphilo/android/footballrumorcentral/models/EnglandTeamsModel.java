...
public class EnglandTeamsModel {
    ...
    public static final TeamModel[] data =
            {
                    new TeamModel("Aston Villa F.C.", "Birmingham, England", "avfc",
                            new String[]{
                    ...
                    new TeamModel("Arsenal F.C.", "London, England", "arsenal",
                            new String[]{
                    ...
                    new TeamModel("A.F.C. Bournemouth", "Bournemouth, England", "bourne",
                            new String[]{
                    ...
                    new TeamModel("Chelsea F.C.", "London, England", "chelsea",
                            new String[]{
                    ...
                    new TeamModel("Crystal Palace F.C.", "London, England", "cpalace",
                            new String[]{
                    ...
                    new TeamModel("Leicester City F.C.", "Leicester, England", "leicester",
                            new String[]{
                                    "http://www.football365.com/leicester-city/rss",
                                    "http://metro.co.uk/tag/leicester-city-fc/feed/"
                            }),
                    new TeamModel("Everton F.C.", "Liverpool, England", "everton",
                            new String[]{
                    ...
                    new TeamModel("Liverpool F.C.", "Liverpool, England", "liverpool",
                            new String[]{
                    ...
                    new TeamModel("Manchester City F.C.", "Manchester, England", "mancity",
                            new String[]{
                    ...
                    new TeamModel("Manchester United F.C.", "Manchester, England", "mufc",
                            new String[]{
                    ...
                    new TeamModel("Newcastle United F.C.", "Newcastle, England", "newcastle",
                            new String[]{
                    ...
                    new TeamModel("Stoke City F.C.", "Stoke-on-Trent, England", "stoke",
                            new String[]{
                                    "http://www.football365.com/stoke-city/rss",
                                    "http://metro.co.uk/tag/stoke-city-fc/feed/",
                                    "http://fourtwothreeonestoke.com/feed/"
                            }),
                    new TeamModel("Sunderland A.F.C.", "Sunderland, England", "sunderland",
                            new String[]{
                    ...
                    new TeamModel("Swansea City A.F.C.", "Swansea, Wales", "swansea",
                            new String[]{
                                    "http://www.football365.com/swansea/rss",
                                    "http://metro.co.uk/tag/swansea-city-fc/feed/",
                                    "http://theswanseaway.co.uk/feed/"
                            }),
                    new TeamModel("Tottenham Hotspur F.C.", "London, England", "thfc",
                            new String[]{
                    ...
                    new TeamModel("Watford F.C.", "Watford, England", "watford",
                            new String[]{
                                    "http://www.football365.com/watford/rss",
                                    "http://forzawatford.com/feed/"
                            }),
                    new TeamModel("West Bromwich Albion F.C.", "West Bromwich, England", "westbrom",
                            new String[]{
                    ...
                    new TeamModel("West Ham United F.C.", "London, England", "westham",
                            new String[]{
